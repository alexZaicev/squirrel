...
func (d *cteData) ExecContext(ctx context.Context) (sql.Result, error) {
	if d.RunWith == nil {
...
func (d *cteData) QueryContext(ctx context.Context) (*sql.Rows, error) {
	if d.RunWith == nil {
		return nil, ErrRunnerNotSet
	}
...
func (d *cteData) QueryRowContext(ctx context.Context) RowScanner {
	if d.RunWith == nil {
